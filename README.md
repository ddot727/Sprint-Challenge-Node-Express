...
`Express allows for easy CRUD implementation and it's helpful for server-side routing`

- [x] Describe Middleware?

`Middleware` is an array of functions that can filter through actions if need be, before they get to the front end of the app

- [x] Describe a Resource?

A `resource` is an object that has types of HTTP requests that can be made.

- [x] What can the API return to help clients know if a request was successful?

The `API` can return a status of `200` if a request was successful.

- [x] How can we partition our application into sub-applications?

We can use `express.router` to break our app up into different routes, preferably grouping up like-minded elements
